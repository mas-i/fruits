...
ActiveRecord::Schema.define(version: 2020_10_02_100835) do
  ...
  create_table "origins", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["variety_id"], name: "index_origins_on_variety_id"
  end
  ...
  create_table "seasons", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["variety_id"], name: "index_seasons_on_variety_id"
  end
  ...
  create_table "varieties", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["fruit_id"], name: "index_varieties_on_fruit_id"
  end

  add_foreign_key "fruits", "users"
  add_foreign_key "origins", "varieties"
  add_foreign_key "seasons", "varieties"
  add_foreign_key "varieties", "fruits"
end
